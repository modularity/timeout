...
export default class TaskList extends Component<Props> {
  constructor(props) {
    super(props);
    this.state = {
      taskDone: (new Map(): Map<string, boolean>),
      taskList: [
        {title:'Activity Task', subTitle:'Subtitle content for the Activity Task', type: 'Task', id: "0", status: '', person: 'John Smith',
        ...
        {title:'Questionnaire Task', subTitle:'Subtitle content for the Questionnaire Task', type: 'Survey', id: "1", status: '',
        ...
        {title:'Feedback Task', subTitle:'Subtitle content for the Feedback Task', type: 'Feedback', id: "2", status: '', person: 'John Smith',
        ...
        {title:'Activity Task2', subTitle:'Subtitle content for the Activity Task', type: 'Task', id: "3", status: '',  person: 'John Smith',
        ...
        {title:'Activity Task3', subTitle:'Subtitle content for the Activity Task', type: 'Task', id: "4", status: '', person: 'John Smith',
